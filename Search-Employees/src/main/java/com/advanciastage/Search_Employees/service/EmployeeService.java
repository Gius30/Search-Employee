...
public class EmployeeService {
	...
	public List<Employees> searchEmployees(Long id_dipartimento, Long id_location, String id_country,
		...
		return repo.search(id_dipartimento, id_location, id_country, nome_employee, id_region, max_salary, min_salary);
	}
	...
	/*
	 * ricorda che se edit_emp non ha id allora verrà creata una nuova entità sennò
	 * verrà aggiornata l'entità con l' id corrispondente
	 */
	...
	public Employees createEmp(String nome, BigDecimal salary) {

		// Crea un nuovo impiegato senza dipartimento (il dipartimento sarà null)
		Employees newEmployee = new Employees();
		newEmployee.setFirst_name(nome); // Nome dell'impiegato
		newEmployee.setSalary(salary); // Salario
